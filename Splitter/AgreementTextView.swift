...
//MARK: setupView
//Sets basic user interactions, colors and text to the textview.
    func setupView() {
...
//MARK: setUpText
//Adds the text tot the text view.
...
//MARK: addTextLinks
//Adds links and colors to the Stripe T's and C's.
    func addTextLinks(text: NSMutableAttributedString) {
